...
# Preparing the matrix to collect projections over 25 years
periods <- 25
n.a.2 <- matrix(NA,nrow=dim(U.pen2)[1],ncol=periods+1)
n.b.2 <- matrix(NA,nrow=dim(U.pen2)[1],ncol=periods+1)
n.c.2 <- matrix(NA,nrow=dim(U.pen2)[1],ncol=periods+1)
...
We can plot the full population for each temperature and initial condition. We are representing here the sum of all stages for each period:
...
for (i in 1:nby) { # use 't' as our looping variable
