...
### store cluster solutions with best empirical fits
#OM
wardrange.OM.indel1 <- cutree(ward.OM , k=6)

### cluster consistency (plot silhouette widths)
#OM 5-cluster solution
silh.OM.6.indel1 <- silhouette(wardrange.OM.indel1, dmatrix = Matrix.OM.State.dep)
...
And when we force the solution to be a 6-cluster:
```{r}
...
plot(silh.OM.6.indel1, main= "Silhouette - OM 6 cluster", border=NA, 
     col=c("#E2E2E2", "#D3D3D3", "#B8B8B8", "#969696", "#707070", "black"))
```
